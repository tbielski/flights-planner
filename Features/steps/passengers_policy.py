...
def step_impl(context):
    context.economy_flight = EconomyFlight("1", "Gdańsk", "Warszawa", datetime(2019, 12, 12, 22, 00))
...
def step_impl(context):
    context.business_flight = BusinessFlight("2", "Gdańsk", "Warszawa", datetime(2019, 12, 12, 22, 00))
...
def step_impl(context):
    context.premium_flight = PremiumFlight("3", "Gdańsk", "Warszawa", datetime(2019, 12, 12, 22, 00))
